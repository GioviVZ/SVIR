...
CREATE TABLE `pedidos` (
  ...
  `estado`      ENUM('PENDIENTE','PARCIAL','PREPARACION','LISTO','ENTREGADO','CANCELADO') NOT NULL DEFAULT 'PENDIENTE',
  `tipo_origen` ENUM('TIENDA','PRESENCIAL','WHATSAPP','WEB') NOT NULL DEFAULT 'PRESENCIAL',
